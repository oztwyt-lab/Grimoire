...
export const INGREDIENT_NUTRITION_SEED: IngredientNutritionSeed[] = [
  ...
  // Placeholder entries for expanded ingredient list. Real USDA values can be populated later with nutrition:build.
  { id: 'sucuk', query: 'turkish sausage sucuk', gramsPerUnit: 100, manualNutritionOverride: { calories: 0, protein: 0, fat: 0, carbs: 0 } },
  { id: 'pastirma', query: 'pastirma pastrami', gramsPerUnit: 100, manualNutritionOverride: { calories: 0, protein: 0, fat: 0, carbs: 0 } },
  { id: 'eggplant_large', query: 'eggplant large raw', gramsPerUnit: 100, manualNutritionOverride: { calories: 0, protein: 0, fat: 0, carbs: 0 } },
  { id: 'cheddar', query: 'cheese cheddar', gramsPerUnit: 100, manualNutritionOverride: { calories: 0, protein: 0, fat: 0, carbs: 0 } },
  { id: 'goat_cheese', query: 'cheese goat soft type', gramsPerUnit: 100, manualNutritionOverride: { calories: 0, protein: 0, fat: 0, carbs: 0 } },
  { id: 'halloumi', query: 'cheese halloumi', gramsPerUnit: 100, manualNutritionOverride: { calories: 0, protein: 0, fat: 0, carbs: 0 } },
  { id: 'kaymak', query: 'kaymak cream', gramsPerUnit: 100, manualNutritionOverride: { calories: 0, protein: 0, fat: 0, carbs: 0 } },
  { id: 'ayran', query: 'ayran yogurt drink', gramsPerUnit: 100, manualNutritionOverride: { calories: 0, protein: 0, fat: 0, carbs: 0 } },
  { id: 'beyaz_peynir', query: 'turkish white cheese', gramsPerUnit: 100, manualNutritionOverride: { calories: 0, protein: 0, fat: 0, carbs: 0 } },
  { id: 'kashar', query: 'kashar cheese', gramsPerUnit: 100, manualNutritionOverride: { calories: 0, protein: 0, fat: 0, carbs: 0 } },
  { id: 'basmati_rice', query: 'rice basmati raw', gramsPerUnit: 100, manualNutritionOverride: { calories: 0, protein: 0, fat: 0, carbs: 0 } },
  { id: 'jasmine_rice', query: 'rice jasmine raw', gramsPerUnit: 100, manualNutritionOverride: { calories: 0, protein: 0, fat: 0, carbs: 0 } },
  { id: 'brown_rice', query: 'rice brown raw', gramsPerUnit: 100, manualNutritionOverride: { calories: 0, protein: 0, fat: 0, carbs: 0 } },
  { id: 'whole_wheat_bread', query: 'bread whole wheat commercially prepared', gramsPerUnit: 100, manualNutritionOverride: { calories: 0, protein: 0, fat: 0, carbs: 0 } },
  { id: 'white_bread', query: 'bread white commercially prepared', gramsPerUnit: 100, manualNutritionOverride: { calories: 0, protein: 0, fat: 0, carbs: 0 } },
  { id: 'sourdough_bread', query: 'bread sourdough', gramsPerUnit: 100, manualNutritionOverride: { calories: 0, protein: 0, fat: 0, carbs: 0 } },
  { id: 'rye_bread', query: 'bread rye', gramsPerUnit: 100, manualNutritionOverride: { calories: 0, protein: 0, fat: 0, carbs: 0 } },
  { id: 'bran_bread', query: 'bread bran', gramsPerUnit: 100, manualNutritionOverride: { calories: 0, protein: 0, fat: 0, carbs: 0 } },
  { id: 'pita_bread', query: 'bread pita white enriched', gramsPerUnit: 100, manualNutritionOverride: { calories: 0, protein: 0, fat: 0, carbs: 0 } },
  { id: 'bagel', query: 'bagels plain enriched', gramsPerUnit: 100, manualNutritionOverride: { calories: 0, protein: 0, fat: 0, carbs: 0 } },
  { id: 'flatbread', query: 'flatbread', gramsPerUnit: 100, manualNutritionOverride: { calories: 0, protein: 0, fat: 0, carbs: 0 } },
  { id: 'cornbread', query: 'cornbread', gramsPerUnit: 100, manualNutritionOverride: { calories: 0, protein: 0, fat: 0, carbs: 0 } },
  { id: 'gluten_free_bread', query: 'bread gluten free', gramsPerUnit: 100, manualNutritionOverride: { calories: 0, protein: 0, fat: 0, carbs: 0 } },
  { id: 'freekeh', query: 'freekeh raw', gramsPerUnit: 100, manualNutritionOverride: { calories: 0, protein: 0, fat: 0, carbs: 0 } },
  { id: 'polenta', query: 'polenta dry', gramsPerUnit: 100, manualNutritionOverride: { calories: 0, protein: 0, fat: 0, carbs: 0 } },
  { id: 'millet', query: 'millet raw', gramsPerUnit: 100, manualNutritionOverride: { calories: 0, protein: 0, fat: 0, carbs: 0 } },
  { id: 'penne', query: 'pasta dry penne', gramsPerUnit: 100, manualNutritionOverride: { calories: 0, protein: 0, fat: 0, carbs: 0 } },
  { id: 'fusilli', query: 'pasta dry fusilli', gramsPerUnit: 100, manualNutritionOverride: { calories: 0, protein: 0, fat: 0, carbs: 0 } },
  { id: 'fettuccine', query: 'pasta dry fettuccine', gramsPerUnit: 100, manualNutritionOverride: { calories: 0, protein: 0, fat: 0, carbs: 0 } },
  { id: 'rigatoni', query: 'pasta dry rigatoni', gramsPerUnit: 100, manualNutritionOverride: { calories: 0, protein: 0, fat: 0, carbs: 0 } },
  { id: 'orzo', query: 'pasta dry orzo', gramsPerUnit: 100, manualNutritionOverride: { calories: 0, protein: 0, fat: 0, carbs: 0 } },
  { id: 'lasagna_sheets', query: 'pasta dry lasagna', gramsPerUnit: 100, manualNutritionOverride: { calories: 0, protein: 0, fat: 0, carbs: 0 } },
  { id: 'biber_salcasi', query: 'red pepper paste', gramsPerUnit: 100, manualNutritionOverride: { calories: 0, protein: 0, fat: 0, carbs: 0 } },
  { id: 'domates_salcasi_tr', query: 'turkish tomato paste', gramsPerUnit: 100, manualNutritionOverride: { calories: 0, protein: 0, fat: 0, carbs: 0 } },
  { id: 'sumac', query: 'spices sumac', gramsPerUnit: 100, manualNutritionOverride: { calories: 0, protein: 0, fat: 0, carbs: 0 } },
  { id: 'nigella_seeds', query: 'seeds nigella', gramsPerUnit: 100, manualNutritionOverride: { calories: 0, protein: 0, fat: 0, carbs: 0 } },
  { id: 'pomegranate_molasses', query: 'pomegranate molasses', gramsPerUnit: 100, manualNutritionOverride: { calories: 0, protein: 0, fat: 0, carbs: 0 } },
  { id: 'grape_leaves', query: 'grape leaves raw', gramsPerUnit: 100, manualNutritionOverride: { calories: 0, protein: 0, fat: 0, carbs: 0 } },
  { id: 'red_kidney_beans', query: 'beans kidney red mature seeds raw', gramsPerUnit: 100, manualNutritionOverride: { calories: 0, protein: 0, fat: 0, carbs: 0 } },
  { id: 'cannellini_beans', query: 'beans cannellini mature seeds raw', gramsPerUnit: 100, manualNutritionOverride: { calories: 0, protein: 0, fat: 0, carbs: 0 } },
  { id: 'green_lentils', query: 'lentils green raw', gramsPerUnit: 100, manualNutritionOverride: { calories: 0, protein: 0, fat: 0, carbs: 0 } },
  { id: 'black_lentils', query: 'lentils black raw', gramsPerUnit: 100, manualNutritionOverride: { calories: 0, protein: 0, fat: 0, carbs: 0 } },
];
